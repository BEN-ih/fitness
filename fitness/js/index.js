...
function initMap() {
  // The location of Uluru               45.511044306040226, -73.5861372209444
  const uluru = { lat: -73.5861372209444, lng: 45.511044306040226 };
  // The map, centered at Uluru
  const map = new google.maps.Map(document.getElementById("mmap"), {
    zoom: 4,
    center: uluru,
  });
